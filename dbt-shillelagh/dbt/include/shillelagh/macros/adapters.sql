...
{% macro shillelagh__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro shillelagh__check_schema_exists(information_schema,schema) -%}
...
{% macro shillelagh__drop_relation(relation) -%}
...
{% macro shillelagh__drop_schema(relation) -%}
...
{% macro shillelagh__get_columns_in_relation(relation) -%}
...
{% macro shillelagh__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro shillelagh__list_schemas(database) -%}
...
{% macro shillelagh__rename_relation(from_relation, to_relation) -%}
...
{% macro shillelagh__truncate_relation(relation) -%}
...
{% macro shillelagh__current_timestamp() -%}
